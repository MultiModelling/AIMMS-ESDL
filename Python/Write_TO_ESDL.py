...
class SQLESDL:
    def __init__(self, host: str, database: str, user: str, password: str):
        ...
        self.tables = self.get_sql("Select table_schema as database_name, table_name from information_schema.tables where table_type = 'BASE TABLE'and table_schema = '" + self.database_name + "' order by database_name, table_name;")
